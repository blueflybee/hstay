...
public class PrefConstant {
  ...
  private static SPUtils sSpUtils = SPUtils.getInstance(SP_NAME);
  ...
  public static String getUserUniqueKey(String deviceType) {
    return "0".equals(deviceType) ? SPUtils.getInstance(SP_NAME).getString(SP_USER_UNIQUE_KEY) : String.valueOf(PrefConstant.getUserId());
  }
